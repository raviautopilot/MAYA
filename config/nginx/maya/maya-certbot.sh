#!/usr/bin/env bash
#
# maya-certbot.sh - Provisions SSL certificate for the maya service.
#
# This script runs Certbot to obtain a certificate for maya.jaganathan.co.uk
# and automatically configures the corresponding Nginx server block.
#
set -euo pipefail

DOMAIN="maya.jaganathan.co.uk"
